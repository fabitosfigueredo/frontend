"""
Django settings for SenacStore project.
...
CSRF_TRUSTED_ORIGINS  = ['https://senacstore-production-0bce.up.railway.app']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'StoreApp.context_processors.listar_departamentos'
            ],
        },
    },
]

WSGI_APPLICATION = 'SenacStore.wsgi.application'
